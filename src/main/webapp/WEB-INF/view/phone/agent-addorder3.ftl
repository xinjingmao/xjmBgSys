...
<div class="container">
    ...
    <div class="row" id="sa-nav">
        <a href="agent-addorder.html"><div class="col-xs-4 sa-nav">基本信息</div></a>
        <a href="agent-addorder2.html"><div class="col-xs-4 sa-nav">添加订单</div></a>
        <a href="agent-addorder3.html"><div class="col-xs-4 sa-nav sa-nav-actived">其它资料</div></a>
    </div>
    <!-- ------------------------学生导航结束--------------------------- -->
    <form>
