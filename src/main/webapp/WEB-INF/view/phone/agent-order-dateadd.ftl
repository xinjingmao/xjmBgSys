...
<div class="container">
    <div class="myhead row">
        <div class="col-xs-2 mh-1"><a href="agent-order-date.html"><img src="img/left.jpg"/></a></div>
        <div class="col-xs-8 mh-2"><strong>添加新订单</strong></div>
    ...
    <form>
        ...
        <div class="row">
            <div class="col-xs-12">
                <button href="agent-order-dateadd.html" class="btn btn-lg" style="width:100%; margin-top: 15px; background: #44b549; color: #fff; ">保存</button>
                <a href="#" class="btn btn-lg"
                        style="width:100%; margin-top: 15px; background: #b1b6b2; color: #fff; margin-bottom: 20px; ">取消</a>
            </div>
        </div>
    </form>
</div>
