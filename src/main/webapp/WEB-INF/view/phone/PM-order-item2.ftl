...
<div class="container">
    <div class="myhead row">
        <div class="col-xs-2 mh-1"><a href="PM-order.html"><img src="img/left.jpg"/></a></div>
        <div class="col-xs-8 mh-2"><strong>详情</strong></div>
        <div class="col-xs-2 mh-3"></div>
    </div>
    <!-- ------------------------学生导航开始--------------------------- -->
    <div class="row" id="sa-nav" style="background: #fff;">
        <a href="PM-order-item.html"><div class="col-xs-6 sa-nav">订单</div></a>
        <a href="PM-order-item2.html"><div class="col-xs-6 sa-nav sa-nav-actived">资料</div></a>
    </div>
    <!-- ------------------------学生导航结束--------------------------- -->
    <form>
        ...
        <div class="row" style="margin-bottom: 20px;">
            <div class="col-xs-12">
                <button href="agent-order-dateadd.html" class="btn btn-lg" style="width:100%; margin-top: 25px; background: #44b549; color: #fff; ">保存</button>
            </div>
        </div>
    </form>
</div>
